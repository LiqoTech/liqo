	...
	Context("check isPeeringEnabled", func() {
		...
		DescribeTable("isPeeringEnabled table",
			func(c isPeeringEnabledTestcase) {
				Expect(controller.isPeeringEnabled(context.TODO(), &c.foreignCluster)).To(c.expected)
			},
			...
			Entry("peering disabled", isPeeringEnabledTestcase{
				foreignCluster: discoveryv1alpha1.ForeignCluster{
					...
					Spec: discoveryv1alpha1.ForeignClusterSpec{
						PeeringEnabled: discoveryv1alpha1.PeeringEnabledNo,
					},
				},
				expected: BeFalse(),
			}),
			...
			Entry("peering enabled", isPeeringEnabledTestcase{
				foreignCluster: discoveryv1alpha1.ForeignCluster{
					...
					Spec: discoveryv1alpha1.ForeignClusterSpec{
						PeeringEnabled: discoveryv1alpha1.PeeringEnabledYes,
					},
				},
				expected: BeTrue(),
			}),

	...
	Describe("Assert that Liqo is up, pod offloading and network connectivity are working", func() {
		Context("Check Join Status", func() {
			...
			DescribeTable("Liqo Pod to Pod Connectivity Check",
				func(homeCluster, foreignCluster tester.ClusterContext) {
				...
				Entry("Check Pod to Pod connectivity from cluster 1 to cluster 2", testContext.Clusters[0], testContext.Clusters[1]),
				Entry("Check Pod to Pod connectivity from cluster 2 to cluster 1", testContext.Clusters[1], testContext.Clusters[0]),
				Entry("Check Pod to Pod connectivity from cluster 2 to cluster 3", testContext.Clusters[1], testContext.Clusters[2]),
				Entry("Check Pod to Pod connectivity from cluster 3 to cluster 2", testContext.Clusters[2], testContext.Clusters[1]),
			)
		})
